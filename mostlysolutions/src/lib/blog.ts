...
export const BLOG_POSTS: BlogPost[] = [
{
  ...
  body: [
    ...
    {
      type: 'h3',
      text: 'Why does my car not start after sitting overnight?',
    },
    {
      type: 'p',
      text: 'A weak battery, faulty alternator, electrical drain, starter motor problem, fuel system fault, ignition problem or faulty sensor can prevent a car from starting after sitting overnight.',
    },

    {
      type: 'h3',
      text: 'Why does my car struggle to start in the morning?',
    },
    {
      type: 'p',
      text: 'A weak battery is a common cause, but starting problems can also be related to the charging system, starter motor, fuel delivery, ignition or engine electronics.',
    },

    {
      type: 'h3',
      text: 'Can a diagnostic test find out why my car will not start?',
    },
    {
      type: 'p',
      text: 'A car diagnostic test in London can identify stored fault codes and provide useful information about electronic vehicle systems. Additional mechanical or electrical testing may also be required to confirm the exact cause.',
      spans: [
        { text: 'A ' },
        { text: 'car diagnostic test in London', href: DIAGNOSTICS },
        { text: ' can identify stored fault codes and provide useful information about electronic vehicle systems. Additional mechanical or electrical testing may also be required to confirm the exact cause.' },
      ],
    },

    {
      type: 'h3',
      text: 'Should I replace my battery if my car will not start?',
    },
    {
      type: 'p',
      text: 'Not necessarily. The battery may be responsible, but the alternator, starter motor or another electrical fault could be causing the problem. Testing the vehicle first can help avoid replacing parts unnecessarily.',
    },

    {
      type: 'h3',
      text: 'Can an alternator cause overnight starting problems?',
    },
    {
      type: 'p',
      text: 'Yes. If the alternator is not charging the battery correctly, the battery can gradually lose its charge and eventually leave the vehicle unable to start.',
    },

    {
      type: 'h3',
      text: 'Why does my car start later but not in the morning?',
    },
    {
      type: 'p',
      text: 'Temperature, battery condition and intermittent electrical or sensor faults can contribute to this problem. Professional engine diagnostics in London can help investigate recurring starting issues.',
      spans: [
        { text: 'Temperature, battery condition and intermittent electrical or sensor faults can contribute to this problem. Professional ' },
        { text: 'engine diagnostics in London', href: DIAGNOSTICS },
        { text: ' can help investigate recurring starting issues.' },
      ],
    },

    {
      type: 'h3',
      text: 'Can you provide mobile car diagnostics in London?',
    },
    {
      type: 'p',
      text: 'Yes. Mostly Solutions provides mobile car diagnostics in London and can attend suitable locations where your vehicle is parked.',
      spans: [
        { text: 'Yes. Mostly Solutions provides ' },
        { text: 'mobile car diagnostics in London', href: DIAGNOSTICS },
        { text: ' and can attend suitable locations where your vehicle is parked.' },
      ],
    },

    {
      type: 'h3',
      text: 'What if my car will not start at home?',
    },
    {
      type: 'p',
      text: 'If your car will not start at home, avoid repeatedly attempting to start it if the battery is becoming weak. Arranging a mobile car diagnostic service in London can allow the vehicle to be investigated at its current location.',
      spans: [
        { text: 'If your car will not start at home, avoid repeatedly attempting to start it if the battery is becoming weak. Arranging a ' },
        { text: 'mobile car diagnostic service in London', href: DIAGNOSTICS },
        { text: ' can allow the vehicle to be investigated at its current location.' },
      ],
    },

    {
      type: 'h3',
      text: 'Can electrical faults be diagnosed?',
    },
    {
      type: 'p',
      text: 'Many electronic and electrical faults can be investigated using professional diagnostic equipment. Some problems may also require additional electrical testing to identify the exact cause.',
    },

    {
      type: 'h3',
      text: 'How can I book a car diagnostic service near me?',
    },
    {
      type: 'p',
      text: 'If you are searching online for a car diagnostic service near me in London, you can contact Mostly Solutions to arrange a mobile diagnostic visit at a suitable location.',
      spans: [
        { text: 'If you are searching online for a ' },
        { text: 'car diagnostic service near me', href: DIAGNOSTICS },
        { text: ' in London, you can contact Mostly Solutions to arrange a mobile diagnostic visit at a suitable location.' },
      ],
    },
  ],
...
},
{
  ...
  body: [
...

    {
      ...
      spans: [
        { text: 'When Should You Arrange a ' },
    ...
    {
      type: 'h3',
      text: 'Why is my car losing power while driving?',
    },
    {
      type: 'p',
      text: 'Loss of power can have several causes, including fuel delivery problems, restricted airflow, sensor faults, turbocharger problems, exhaust restrictions and electrical or engine management issues. A professional diagnostic check can help identify the possible cause.',
    },

    {
      type: 'h3',
      text: 'Can a faulty sensor cause loss of engine power?',
    },
    {
      type: 'p',
      text: 'Yes. A faulty sensor can send incorrect information to the vehicle’s engine management system, which may affect engine performance. Diagnostic testing can help identify relevant sensor related faults.',
    },

    {
      type: 'h3',
      text: 'Is it safe to drive a car that is losing power?',
    },
    {
      type: 'p',
      text: 'It depends on the severity and symptoms. If the vehicle is overheating, producing smoke, making unusual noises or experiencing severe power loss, you should avoid continuing to drive it unnecessarily and seek professional assistance.',
    },

    {
      type: 'h3',
      text: 'Can a diagnostic test find the reason my car is losing power?',
    },
    {
      type: 'p',
      text: 'A car diagnostic test can identify stored fault codes and provide information about electronic systems. Further testing may be needed to establish the exact underlying cause.',
    },

    {
      type: 'h3',
      text: 'What if my car loses power but no warning light appears?',
    },
    {
      type: 'p',
      text: 'A warning light does not always appear when a vehicle develops a problem. If you repeatedly experience reduced performance, it is still worth arranging a professional inspection.',
    },

    {
      type: 'h3',
      text: 'Can I get mobile car diagnostics in London?',
    },
    {
      type: 'p',
      text: 'Yes. Mobile car diagnostics in London allows a technician to attend a suitable location, which can be particularly useful when you are concerned about driving the vehicle to a garage.',
    },

    {
      type: 'h3',
      text: 'What should I search for if I need a mobile diagnostic service?',
    },
    {
      type: 'p',
      text: 'Many drivers search for mobile car diagnostics near me when they want a technician to come to their location. You can also search for a mobile car diagnostic service in London to find suitable local options.',
    },

    {
      type: 'h3',
      text: 'Can electrical problems cause poor car performance?',
    },
    {
      type: 'p',
      text: 'Some electrical and electronic faults can affect vehicle performance. Depending on the symptoms, battery, charging system, wiring and vehicle control systems may need to be investigated.',
    },

    {
      type: 'h3',
      text: 'Should I clear the warning light myself?',
    },
    {
      type: 'p',
      text: 'Clearing a warning light without identifying the cause does not necessarily fix the problem. It is better to establish why the warning light appeared before deciding what action is required.',
    },
  ],
